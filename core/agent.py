...
class TradingAgent:
    ...
    def run_cycle(self) -> Dict[str, Any]:
        ...
        logger.info(f"Portfolio: ${portfolio.get('total_equity', 0):.2f} | "
                   f"Exposure: {current_exposure:.1f}%")

        # Get global sentiment and news (shared across symbols)
    ...
    def _process_symbol(
        ...
        has_position = exchange_client.has_open_position(symbol)
