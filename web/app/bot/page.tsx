        ...
        <div className="grid grid-cols-4 gap-4 p-4 bg-gray-900/50 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-bold">{formatCurrency(parseFloat(latestSnapshot.total_equity_usdc || '0'))}</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-bold">{formatCurrency(parseFloat(latestSnapshot.available_balance_usdc || '0'))}</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-bold">{parseFloat(latestSnapshot.exposure_pct || '0').toFixed(1)}%</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
